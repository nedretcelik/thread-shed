...
for each_t in daily_transactions:
  daily_transactions_split.append(each_t.split("-"))
...
for all_colors in thread_sold_split:
  if all_colors not in colors:
    colors.append(all_colors)
